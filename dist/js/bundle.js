...
var widthTablet = window.matchMedia('(max-width: 767px)');

var destroySwiper = function destroySwiper(event) {
...
document.querySelector('.catalog__button').addEventListener('click', function () {
  ...
  var buttonText = document.querySelector('.button__text');
  buttonText.textContent = list.classList.contains('catalog__list--expanded') ? 'Скрыть' : 'Показать все';
});

function checkCatalogItems() {
  var list = document.querySelector('.catalog__list');
  var button = document.querySelector('.catalog__button');
...
document.addEventListener('DOMContentLoaded', function () {
  document.querySelector('.catalogs__button').addEventListener('click', function () {
    var list = document.querySelector('.catalogs__list');
    var icon = document.querySelector('.buttons__icon');
    list.classList.toggle('catalogs__list--expanded');
    icon.classList.toggle('buttons__icon--rotated');
    var buttonText = document.querySelector('.buttons__text');
    buttonText.textContent = list.classList.contains('catalogs__list--expanded') ? 'Скрыть' : 'Показать все';
  });

  function checkCatalogItems() {
    var list = document.querySelector('.catalogs__list');
    var button = document.querySelector('.catalogs__button');
    var items = document.querySelectorAll('.catalogs__item');
...
var sidebarDialog = document.getElementById('sidebarDialog');
...
var callbackModal = document.getElementById('callback__modal');
var openCallbackBtn = document.getElementById('open__callback');
var closeCallbackBtn = document.querySelector('.modal__close');
...
var callbackForm = document.getElementById('callback__form');
callbackForm.addEventListener('submit', function (e) {
  e.preventDefault();
  alert('Форма отправлена!');
  callbackModal.classList.remove('modal__overlay--active');
});
var callbacksModal = document.getElementById('callback__modals');
var openCallbacksBtn = document.getElementById('open__callbacks');
var closeCallbacksBtn = document.querySelector('.modals__close');
var callbacksForm = document.getElementById('callbacks__form');
var submitButton = document.querySelector('.submits__button');

if (openCallbacksBtn && callbacksModal) {
  openCallbacksBtn.addEventListener('click', function () {
...
if (closeCallbacksBtn) {
  closeCallbacksBtn.addEventListener('click', function () {
...
if (callbacksModal) {
  callbacksModal.addEventListener('click', function (e) {
...
document.addEventListener('DOMContentLoaded', function () {
  var readMoreButton = document.querySelector('.content__reed');
  var textElements = {
  ...
  var link = readMoreButton.querySelector('.content__item-press');
  var isExpanded = false;
  readMoreButton.addEventListener('click', function (e) {
    e.preventDefault();

    if (!isExpanded) {
      Object.values(textElements).forEach(function (el) {
        if (el) {
